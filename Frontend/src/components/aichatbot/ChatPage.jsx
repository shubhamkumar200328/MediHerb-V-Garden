...
const ChatPage = () => {
  ...
  const hideHeaderPaths = ['/aichatpage'];
  ...
  return (
    <div className="">
      ...
      <div className="w-full max-w-6xl bg-white rounded-lg shadow-lg p-6 m-auto my-10">
        <h1 className="text-2xl font-bold text-green-700 mb-4 m-auto">
